#Uses the trained model to predict on new user input. This is the file typically called by a Streamlit app when the user clicks Predict.
# Predictions
...
class Predictor:
    ...
    def __init__(self):
        ...
        self.model_path = "saved_models/lstm_model.keras"
    ...
    def predict(self):
        ...
        saved_models = load_model(self.model_path)
        ...
        predictions = saved_models.predict(X_test)
